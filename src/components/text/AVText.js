...
class EventHeader extends React.Component {
  render() {
    return <Text {...this.props} style={{ fontFamily: 'exo-bold', fontSize: 22, color: Colors.black, paddingBottom: 5 }} />;
  }
}
...
class EventSpeaker extends React.Component {
  render() {
    return <Text {...this.props} style={{ fontFamily: 'exo', fontSize: 18, color: Colors.gray, ...this.props.style }} />;
  }
}
...
class AVText extends React.Component {
  render() {
    ...
    return <Text {...this.props} style={{ paddingTop:10, fontFamily: 'exo', fontSize: 18, color: Colors.black, ...style }} />;
  }
}

class AVHeader extends React.Component {
  render() {
    const cssStyle = { paddingTop:5, fontFamily: 'exo-bold', fontSize: 25, color: Colors.hanBlue };
...
class AVHeader2 extends React.Component {
  render() {
    const cssStyle = { paddingTop:15, fontFamily: 'exo-bold', fontSize: 22, color: Colors.spaceNavy };
    return <Text {...this.props} style={cssStyle} />;
  }
}
