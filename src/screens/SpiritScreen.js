...
import { PageHeader, Anchor, AVHeader, AVText } from "../components/text/AVText";
          ...
          <Card>
            <CardItem>
              <Body>
                ...
                <AVText>Doprovázet nás bude kněz Jan Pacner z Brna, se kterým, jakožto i dalšími kněžími, se můžeš setkat také při svátosti smíření či duchovních rozhovorech. K dispozici k rozhovorům budou i další zasvěcené osoby, všechny poznáš podle symbolu naslouchajícího ucha. Když je potkáš a budeš mít něco na srdci, neboj se je oslovit. Bližší informace o místě zpovědí a duchovních rozhovorů na daný den dostaneš na <AVText bold>nástěnce u recepce Stojanov.</AVText></AVText>
                <AVText>Pokud rád/a chválíš Pána hudbou a zpěvem, neměly by ti uniknout páteční večerní <AVText bold>Lamačské chvály</AVText> nebo sobotní též večerní modlitby se <AVText bold>zpěvy z Taizé</AVText>. Během jejich konání bude možné využít přímluvné modlitby.</AVText>
                <AVText>Během celého setkání se můžeš <AVText bold>vydat na malou pouť po okolí</AVText>, mapka se zastaveními k zamyšlení a hlubšímu rozjímání nad mottem letošního AV je vyvěšena na recepci. Můžeš se těšit na celkem čtyři zastavení, na nichž tě čekají úryvky z Písma, otázky k zamyšlení, modlitba a jeden delší úryvek z Božího slova k rozjímání. Jednotlivá zastavení na sebe navazují, a proto ducháčci doporučují absolvovat je v určeném pořadí. K nasávání rovněž vybízí atmosféra místa, které z hlediska osídlení a vyznávání Pána sahá hluboko do dějin našeho národa. Nech se alespoň na chvíli unést ze současné každodennosti a spolu s celou krajinou chval v srdci Hospodina.</AVText>
              </Body>
            </CardItem>
          </Card>
        </Content>
