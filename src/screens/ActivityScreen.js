...
import { AVText, PageHeader, EventTime, EventPlace, EventSpeaker, AVHeader } from "../components/text/AVText";
    ...
    render() {
        ...
        return (
            <Container style={{ padding: 10, }}>
                ...
                <Grid style={{ maxHeight: 70, flex: 1, marginTop: 10, marginBottom: 10, backgroundColor: Color.steelGray_light,  }}>
                    <Row style={{ height: 60 }}>
                        <Col style={{
                            flex: 1,
